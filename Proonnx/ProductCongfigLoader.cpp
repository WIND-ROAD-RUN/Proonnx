...
ProductConfig ProductConfigLoader::loadConfig(const std::string& filePath)
{
	...
	spdlog::info(result.ExposureTime);
	spdlog::info(result.productName);
	spdlog::info(result.rotateCount);
	spdlog::info(result.leftLowerCorner.first);
	spdlog::info(result.leftLowerCorner.second);
	spdlog::info(result.lowerRightCorner.first);
	spdlog::info(result.lowerRightCorner.second);
	spdlog::info(result.topLeftCorner.first);
	spdlog::info(result.topLeftCorner.second);
	spdlog::info(result.upperRightCorner.first);
